...
np.save('X1C.npy', X1)
np.save('X2C.npy', X2)
np.save('X1TestC.npy', X1Test)
np.save('X2TestC.npy', X2Test)
np.save('muHat1C.npy', muHat1)
np.save('muHat2C.npy', muHat2)
np.save('sigmaHat1C.npy', sigmaHat1)
np.save('sigmaHat2C.npy', sigmaHat2)